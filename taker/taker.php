...
<div class="nav"><a href="#allow">提货申请*</a><a href="#inout">出入库信息</a><a href="#disp">商品信息显示</a><a href="#query">商品信息查询</a></div>
<div class="title"><div class="title_left"><b><?php echo $_SESSION['uid'];?></b> 销售员</div> <div class="title_right"><a href="./admin/logout.php">登出</a></div></div>
<div class="sub_content">
<div class="title" id="allow"><b>提货申请*</b></div>
...
?>
<div class="entry_content"> 
	<form name="in_apply" action="./taker/take.server.php" method=post> 
		<table class="table_type1">
		<tr class="first_row_type1"><th>商品编号</th><th>商品名称</th><th>出库数目</th></tr>
